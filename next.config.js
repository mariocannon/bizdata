...
const nextConfig = {
  experimental: {
    ...
    // Next 14 — at the top level it is silently dropped (Next warns
    // "Unrecognized key(s) in object: 'outputFileTracingIncludes'") and the
    // engine ships only if tracing happens to find it on its own.
